...
import { Eye, EyeClosed, Headphones, Headset } from "lucide-react";
      ...
      <div className="flex h-full flex-col gap-40 w-full justify-start">
        ...
        <div className="flex flex-col gap-20">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-lg font-inter">Entre com suas credenciais para acessar a sua conta.</p>
          </div>
          <div className="flex flex-col gap-8">
            ...
            suffix={
              isPasswordVisible ?
              <EyeClosed color="#777A84" onClick={() => setIsPasswordVisible(!isPasswordVisible)} className="cursor-pointer" /> : <Eye color="#777A84" onClick={() => setIsPasswordVisible(!isPasswordVisible)} className="cursor-pointer"/>
            }
              placeholder="Senha"
              required
              name="password"
          ...
          <div className="flex justify-between">
            ...
            <Link href="#" className="text-accent-blue hover:text-white transition-colors">Esqueci minha senha</Link>
          </div>
